...
[ ${#} -eq 0 ] && sh ${0} help && exit
[ ${#} -eq 1 ] && [ ${1} = "first" ] && sh ${0} create start put install && exit
...
DOCKER_CONTAINER=docker-fuhaha-opencv-js
DOCKER_IMAGE=docker-fuhaha-opencv-js
DOCKER_IMAGE_TAG=1
PROJECT=/root/project/opencv_js
